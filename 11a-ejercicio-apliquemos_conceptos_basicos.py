...
num_estudiantes = int(______("¿Cuántos estudiantes deseas registrar? "))

# Bucle para ingresar los datos de cada estudiante
___ i in range(num_estudiantes):
...
for nombre, notas in estudiantes.items():
    ...
    promedio = sum(notas) / _____  # <--- Completar recuerda que el promedio es la suma de las notas entre la cantidad de notas
    
    # TODO: Determinar si el estudiante aprobó (mínimo 60)
    if promedio >= 60:
        estado = "_____"  # Si la condición se cumple, el estado es?
    else:
        estado = "_____"  # Si la condición no se cumple, el estado es?
...
promedio_clase = promedio_total / _____  # <--- Completar
